...
<head>
    ...
    <meta name="Description" content="HOD Login System">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.1.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <title>Teacher/Faculty Login</title>
    <style>
        body {
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-card">
                    <div class="login-header text-center">
                        <h1 class="mb-3"><i class="fas fa-lock"></i> Teacher/Faculty Portal</h1>
                        <p class="mb-0">Secure Access for Teachers/Facultys</p>
                    </div>
                            ...
                            try {
                                ...
                                if ($rs->num_rows > 0) {
                                    ...
                                    if (password_verify($pwd, $row['pwd'])) {
                                        if ($row['role'] == "hod") {
                                            $hsrc = "SELECT u.*, t.* FROM user u INNER JOIN teacher t ON u.email_id=t.email_id WHERE u.email_id='$email_id' AND t.status='1' AND t.hod='Yes'";
                                            $hrs = $con->query($hsrc);
                                            if ($hrs->num_rows > 0) {
                                                ...
                                                $log_date = date("Y-m-d");
                                                $log_time = date("H:i");
                                                $upd = "UPDATE user SET log_date='$log_date',log_time='$log_time' WHERE uid=" . $hrow['uid'];
                                                $con->query($upd);
                                                $_SESSION['h_info'] = $hrow;
                        ?>
                                                <script>
