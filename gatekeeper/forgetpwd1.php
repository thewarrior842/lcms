...
<head>
    ...
    <meta name="Description" content="Gatekeeper Forget Password System">
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-card">
                    <div class="login-header text-center">
                        <h1 class="mb-3"><i class="fas fa-lock"></i> Gatekeeper Forgot password Portal</h1>
                                ...
                                if ($code == $postcode) {
                                    if ($pwd == $cpwd) {
                                        try {
                                            ...
                                            $upd = "UPDATE user SET pwd='$pwd' WHERE email_id='$email_id'";
                                            $con->query($upd);
