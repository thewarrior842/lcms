...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Welcome back, <?php echo htmlspecialchars($_SESSION['h_info']['tfname'] . " " . $_SESSION['h_info']['tlname']); ?>!</p>
        </div>
        <div class="d-flex align-items-center">
            <div class="user-avatar me-3">
                <?php echo strtoupper(substr($_SESSION['h_info']['tfname'], 0, 1) . substr($_SESSION['h_info']['tlname'], 0, 1)); ?>
            </div>
            <div>
